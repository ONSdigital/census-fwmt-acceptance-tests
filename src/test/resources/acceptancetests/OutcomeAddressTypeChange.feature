...
Feature: Outcome Address Type Change Tests
  ...
  Scenario Outline: As a Gateway I can receive an outcome from TM and create Census Events
    ...
    Examples:
      ...
      | HH         | Address Type Changed CE  | Not Valid       | Phone - Property is a CE        | 01-03-06     | F            | F                    | ADDRESS_TYPE_CHANGED_CE                                  | ADDRESS_TYPE_CHANGED                                           | ADDRESS_TYPE_CHANGED |            |
      | HH         | Address Type Changed CE  | Not Valid       | Phone - Property is a CE        | 01-03-07     | F            | F                    | ADDRESS_TYPE_CHANGED_CE,HARD_REFUSAL_RECEIVED            | ADDRESS_TYPE_CHANGED,REFUSAL_RECEIVED                          | ADDRESS_TYPE_CHANGED |            |