...
Feature: Outcome Tests
  ...
  Scenario Outline: As a Gateway I can receive an outcome from TM and create Census Events
   ...
   | CE         | Switch Feedback Unit      | Irrelavant     | Irrelavant        | 24-30-04     | T            | T                    | SWITCH_FEEDBACK_CE_UNIT_F,FULFILMENT_REQUESTED,LINKED_QID                                      | QUESTIONNAIRE_LINKED,FULFILMENT_REQUESTED                        | SWITCH_CE_TYPE    |
