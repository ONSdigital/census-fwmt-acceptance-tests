...
Feature: Outcome Tests
  ...
  Scenario Outline: As a Gateway I can receive final outcome of cases from TM
    ...
    Examples:
      ...
      | derelict     | Non-valid household | Derelict          | Gateway.Address.Update     |
      | ceNoContact  | Non-valid household | CE - No contact   | Gateway.Address.Update     |
      | ceContact    | Non-valid household | CE - Contact made | Gateway.Address.Update     |
...
#    And the message is in the format RM is expecting from queue "Gateway.Fulfillment.Request"
    ...
    Examples:
      ...
      | callBackAnotherTime             | Asked to call back another time   |
