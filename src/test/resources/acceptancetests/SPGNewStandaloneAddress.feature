...
Feature: SPG Outcome Tests
  ...
  Scenario Outline: As a Gateway I can receive a SPG outcomes of cases from TM and create Census Events
    ...
    Examples:
      ...
      | NEW_STANDALONE_ADDRESS | Access Granted - Contact made | HICL or Paper H Questionnaire delivered | 10-20-05     | NEW_STANDALONE_ADDRESS,LINKED_QID           | NEW_ADDRESS_REPORTED,LINKED_QID           |
