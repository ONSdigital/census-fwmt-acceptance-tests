...
Feature: Outcome New Address Reported Tests
  ...
  Scenario Outline: As a Gateway I can receive an outcome from TM and create Census Events
   ...
   | CCS PL     | Property Listed HH       | Contact Made                  | Property Listed                  | 30-01-02     | F            | F                    | PROPERTY_LISTED_HH,LINKED_QID                            | CCS                                      | CCS                   |                  |
   | CCS PL     | Property Listed HH       | Contact Made                  | Property Listed                  | 30-01-02     | T            | F                    | PROPERTY_LISTED_HH,LINKED_QID                            | CCS,QUESTIONNAIRE_LINKED                 | CCS                   |                  |

   | CCS PL     | Property Listed CE       | Contact Made                  | Property Listed                  | 30-02-02     | F            | F                    | PROPERTY_LISTED_CE                                       | CCS                                      | CCS                   |                  |
   | CCS PL     | Interview Required HH    | Contact Made                  | Property Listed                  | 30-01-01     | F            | F                    | INTERVIEW_REQUIRED_HH                                    | CCS                                      | CCS                   |                  |
   | CCS PL     | Interview Required CE    | Contact Made                  | Property Listed                  | 30-02-01     | F            | F                    | INTERVIEW_REQUIRED_CE                                    | CCS                                      | CCS                   |                  |
