...
Feature: Census Tests
  ...
  Scenario: As Gateway I can send a HouseHold update with pause job request from RM
  ...
  Scenario: As Gateway I can't send a HouseHold update with pause job request from RM with a missing CaseId
