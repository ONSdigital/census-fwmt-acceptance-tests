...
@CucumberOptions(plugin = {"pretty", "json:build/cucumber-report.json"},
    features = {"src/test/resources/acceptancetests/CensusTests.feature", "src/test/resources/acceptancetests/CETests.feature", "src/test/resources/acceptancetests/NISRATests.feature"},
